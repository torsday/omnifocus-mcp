...
export const TASK_RECLASSIFY_DESCRIPTION =
  ...
  "prior dry-run; mismatch fails fast. Caps at 200 matches per apply; use task_batch_update with explicit IDs " +
  "for larger sets. " +
  "Predicate AST: title-contains / tag / project leaves and and / or / not combinators (full shape in JSONSchema). " +
  "Changes apply uniformly: addTags, removeTags, setProject, setFlagged. " +
