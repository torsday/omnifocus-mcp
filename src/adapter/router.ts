...
export const ROUTING_TABLE: Readonly<Record<AdapterMethod, TransportName>> = Object.freeze({
  ...
  searchTasks: "jxa",
  getForecast: "jxa",
  getForecastTagWithName: "omnijs", // Database.forecastTag is OmniJS-only
  setForecastTagWithName: "omnijs",

  // -- Perspectives ---------------------------------------------------------
  listPerspectives: "jxa",
  evaluatePerspective: "jxa",
  evaluateCustomPerspective: "omnijs",
  evaluatePerspectiveRules: "omnijs",
...
export class TransportRouter implements OmniFocusAdapter {
  ...
  getForecastTagWithName(): Promise<{
    tagId: import("../domain/ids.js").TagId | null;
    name: string | null;
  }> {
    return this.pick("getForecastTagWithName").getForecastTagWithName();
  }

  setForecastTagWithName(
    tagId: import("../domain/ids.js").TagId | null,
  ): Promise<{ tagId: import("../domain/ids.js").TagId | null; name: string | null }> {
    return this.pick("setForecastTagWithName").setForecastTagWithName(tagId);
  }
  ...
  evaluatePerspectiveRules(
    ...
    return this.pick("evaluatePerspectiveRules").evaluatePerspectiveRules(rules, aggregation);
  }
  ...
  getWindowState(): Promise<{
    ...
    return this.pick("getWindowState").getWindowState();
  }

  setWindowPerspective(perspectiveName: string): Promise<{ perspectiveName: string }> {
    return this.pick("setWindowPerspective").setWindowPerspective(perspectiveName);
  }
