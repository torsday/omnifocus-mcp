...
- Prereqs: Node.js 20 or 22 (documented; `npx` takes care of ensuring a compatible runtime for most users)
...
- **Users on older Node versions** (18, 16) — the bundle targets Node 20+; older versions fail loudly at startup with a version-mismatch error. Documented.
