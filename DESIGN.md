...
4. **The SQLite database file** — undocumented, unstable; **do not touch** (noted here and in CLAUDE.md gotchas; no ADR — the decision is too obvious to contest)
...
- `docs/adr/0001-language-and-runtime.md` — TypeScript + Node 20
